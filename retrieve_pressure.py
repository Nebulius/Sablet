...
write_file = Path('/home/pi/ballon/pres/pressure.tsv')
...
while datetime.now() - startup < one_minute:
    pressure, altitude, cTemp = get_pressure(bus)
    write_file.write_lines(['{}\t{}\t{}\t{}'.format(time.time(), pressure, altitude, cTemp)], append=True)
